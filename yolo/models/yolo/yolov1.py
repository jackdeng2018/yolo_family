...
from yolo.utils import box_ops

from yolo.models.basic import Conv
from yolo.models.neck import build_neck
from yolo.models.backbones import build_backbone
...
class YOLOv1(nn.Module):
    ...
    def forward(self, x, targets=None):
        if not self.trainable:
            ...
            return obj_pred, cls_pred, giou_pred,